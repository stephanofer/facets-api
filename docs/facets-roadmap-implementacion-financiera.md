...
| ----- | ----------------------------------- | ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| 5     | **Clasificación financiera**        | 2, 3              | Las transacciones necesitan caer sobre una taxonomía consistente desde el día 1. Si esto entra tarde, después corregir datos es doloroso. | `Category`, `SystemMerchantCatalog`, `Merchant`, `Tag`                                                                              | `Comida > Supermercado`, merchant `Starbucks` (copiado del catálogo al workspace), tag `vacaciones`. |
